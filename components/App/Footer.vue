<template>
  <footer
    :class="`style-4 ${noWave ? 'mt-0 pt-100' : ''}`"
    data-scroll-index="8"
  >
    <div class="container">
      <div class="section-head text-center style-4">
        ...
        <div class="d-flex align-items-center justify-content-center mt-50">
          ...
          >
            <small>
              <i class="fab fa-apple me-2 pe-2 border-end"></i>
              {{
          ...
          >
            <small>
              <i class="fab fa-google-play me-2 pe-2 border-end"></i>
              {{ rtl ? "تنزيل من متجر ابل" : "Download On Google Play" }}</small
            >
          </a>
        </div>
      </div>
      <div class="foot mt-80">
        <div class="row align-items-center">
          ...
          <div class="col-lg-8">
            <ul class="links">
              <li>
                <NuxtLink to="/home-app-landing" class="active">{{
                  rtl ? "الرئيسية" : "Home"
                }}</NuxtLink>
              </li>
              <li>
                <NuxtLink to="/page-about-5">{{
                  rtl ? "من نحن" : "about"
                }}</NuxtLink>
              </li>
              <li>
                <NuxtLink to="/page-product-5">{{
                  rtl ? "المنتجات" : "product"
                }}</NuxtLink>
              </li>
              <li>
                <NuxtLink to="/page-portfolio-5">{{
                  rtl ? "المشاريع" : "portfolio"
                }}</NuxtLink>
              </li>
              <li>
                <NuxtLink to="/page-services-5">{{
                  rtl ? "الخدمات" : "services"
                }}</NuxtLink>
              </li>
              <li>
                <NuxtLink to="/page-shop-5">{{
                  rtl ? "المتجر" : "shop"
                }}</NuxtLink>
              </li>
              <li>
                <NuxtLink to="/page-blog-5">{{
                  rtl ? "الاخبار" : "blog"
                }}</NuxtLink>
              </li>
              <li>
                <NuxtLink to="/page-contact-5">{{
                  rtl ? "اتصل بنا" : "contact"
                }}</NuxtLink>
              </li>
            </ul>
          </div>
      ...
      <div class="copywrite text-center">
        <small class="small">
          {{ rtl ? "© 2023 حقوق التأليف والنشر" : "© 2023 Copyrights by" }}
          <a href="#" class="fw-bold text-decoration-underline">Iteck Co.</a>
          {{
            rtl

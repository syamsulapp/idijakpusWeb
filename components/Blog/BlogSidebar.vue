    ...
    <div class="side-blog style-5 ps-lg-5 mt-5 mt-lg-0">
      ...
      <div class="side-recent-post mb-50">
        ...
        <NuxtLink
          ...
          :key="index"
          :class="`post-card ${
            index !== sidebarData.recentPosts.length - 1
      ...
      <div class="side-categories mb-50">
        ...
        <a
          href="#"
          class="cat-item"
          v-for="(category, index) in sidebarData.categories"
          :key="index"
        >
      ...
      <div class="side-newsletter mb-50">
        ...
        <form action="contact.php" class="form-subscribe" method="post">
          ...
          <button
            :class="`btn bg-blue${styleType} sm-butn text-white hover-darkBlue w-100 mt-3 radius-5 py-3`"
          >
      ...
      <div class="side-insta mb-50">
        ...
        <div class="d-flex justify-content-between flex-wrap">
          <a
            ...
            v-for="(image, index) in sidebarData.instagram"
            :key="index"
      ...
      <div class="side-tags">
        ...
        <div class="content">
          <a
            href="#"
            v-for="(tag, index) in sidebarData.tags"
            :key="index"
            class="me-1"
            >{{ tag }}</a
          >

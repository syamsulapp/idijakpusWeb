      ...
      <div class="content">
        <div class="blog_slider">
          <swiper class="swiper-container" :options="swiperOptions">
            <swiper-slide v-for="(webinar, index) in webinars" :key="index">
              <div
                class="blog_box"
              ...
              >
                <div class="tags">
                  <a href="#">{{ webinar.type }}</a>
                </div>
                <div class="img">
                  <img :src="webinar.cover" alt="" />
                </div>
                <div class="info">
                  <h6>
                  ...
                  <div class="auther">
                    <span>
                      <img class="auther-img" :src="webinar.userPic" alt="" />
                      <small
                        ><a href="#">By {{ webinar.user }}</a></small
                      >
                    </span>
                    <span>
                      <i class="bi bi-calendar2"></i>
                      <small
                        ><a href="#">{{ webinar.date }}</a></small
                      >
                    </span>
                  </div>
                  <div class="text">{{ webinar.details }} [...]</div>
                </div>
              </div>
            </swiper-slide>
          </swiper>

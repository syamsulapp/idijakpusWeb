      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav m-auto mb-2 mb-lg-0 ps-4">
          ...
          >
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown1">
              <li>
                <NuxtLink to="/page-about-app" class="dropdown-item"
                  >about</NuxtLink
                >
              </li>
              <li>
                <NuxtLink to="/page-product-app" class="dropdown-item"
                  >product</NuxtLink
                >
              </li>
              <li>
                <NuxtLink to="/page-services-app" class="dropdown-item"
                  >services</NuxtLink
                >
              </li>
              <li>
                <NuxtLink to="/page-shop-app" class="dropdown-item"
                  >shop</NuxtLink
                >
              </li>
              <li>
                <NuxtLink to="/page-single-project-app" class="dropdown-item"
          ...
          <li class="nav-item">
            <NuxtLink to="/page-blog-app" class="nav-link"> blog </NuxtLink>
          </li>
          <li class="nav-item">

<template>
  <nav
    class="navbar navbar-expand-lg navbar-light style-5"
        ...
        <ul class="navbar-nav m-auto mb-2 mb-lg-0 text-uppercase">
          ...
          >
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown1">
              ...
              <li>
                <NuxtLink to="/page-single-post-5" class="dropdown-item"
                  >single post</NuxtLink
                >
              </li>
            </ul>
          </li>
          ...
          <li class="nav-item">
            <NuxtLink to="/page-blog-5" class="nav-link">
              blog
              <small
                class="fs-10px icon-20 rounded-pill bg-blue5 text-white fw-bold px-3 ms-2 d-inline-flex justify-content-center align-items-center"
                >3</small
              >
            </NuxtLink>
          </li>

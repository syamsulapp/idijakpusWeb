<template>
  <section
    class="contact section-padding border-bottom border-1 brd-gray style-6"
  >
    <div class="container">
      <div class="section-head text-center mb-70 style-5">
        <h2 class="mb-20">
          {{ rtl ? "احصل على " : "Ready To Start A" }}
          <span>{{ rtl ? "استشارة مجانية" : "Projects" }}</span>
        </h2>
        <p>
          {{
            rtl
                ...
                <div class="col-lg-6">
                  <div class="form-group mb-20">
                    <input
                      ...
                      class="form-control"
                      :placeholder="
                        rtl ? 'رقم الهاتف (اختيارى)' : 'Phone Number (option)'
                      "

  ...
  <section class="about-app style-5">
    <div class="container">
      <div class="content text-center">
              ...
              <div class="about-card mb-30 mb-lg-0">
                ...
                <h6>
                  ...
                  <template v-else
                    ...
                    {{ item.description.part2 }}</template
                  >
                </h6>
              </div>
            </div>
        ...
        <div
          class="img-content pt-70 pb-70 border-bottom brd-gray overflow-hidden"
        >
            ...
            <div class="col-lg-7">
              ...
              <div class="info mt-30">
                <h5 class="lh-4">
                  {{
                    rtl
                      ? "حافظ على تركيزك وإنتاجيتك مع مساحة ملاحظات نظيفة وخالية من الفوضى. الطرق المرنة لتنظيم ملاحظاتك: علامات التجزئة ، دفاتر الملاحظات المتداخلة ، تثبيت الملاحظات في أعلى قائمة الملاحظات ، إلخ."
                ...
                <a href="#" :class="`color-blue${styleType} mt-60`"
                  >https://example.domain</a
                >
              </div>
            </div>
          </div>
...
export default {
  ...
  data() {
    return {
      metadata: this.rtl ? aboutMetadataRTL : aboutMetadata,
    };
  },
};
</script>

        ...
        <div class="col-lg-5">
          <div class="blog-content">
            <div class="section-head style-3 d-flex align-items-center mb-50">
              ...
              <NuxtLink to="/page-blog-5" class="text-muted ms-5 ps-5 mt-2"
                >All Articles <i class="bi bi-chevron-right ms-1"></i
              ></NuxtLink>
            </div>
            <div
            ...
            >
              <div class="row align-items-center">
                <div class="col-lg-4">
                  <NuxtLink to="/home/berita" class="img img-cover">
        ...
        <div class="col-lg-5">
          <div class="faq style-3">
            ...
            <div class="accordion" id="accordionExample">
              ...
              <NuxtLink
                to="/page-contact-5"
                class="text-muted text-uppercase mt-50 small"
              >

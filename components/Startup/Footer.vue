      ...
      <div class="row gx-0 justify-content-between">
        ...
        <div class="col-lg-2">
          <div class="items">
            ...
            <ul>
              <li
                v-for="(information, index) in FooterData.information"
                :key="index"
              >
            ...
            <small class="color-666"
              >{{
                rtl
                  ...
                  : "Register now to get latest updates on"
              }}
              <br />
              {{ rtl ? "الترقيات والقسائم." : "promotions & coupons." }}</small
            >
            <form action="contact.php" class="form mt-30" method="post">
              <div class="form-group">
                ...
                <input
                  type="text"
                  :placeholder="
                    rtl ? 'ادخل بريدك الالكترونى' : 'Enter your email'
                  "
                />
                <button><i class="bi bi-send"></i></button>
              </div>
            </form>
            <small class="color-666 fst-italic mt-20"
              >{{
                rtl
                  ? "من خلال الاشتراك ، فإنك توافق على"
                  : "By subscribing, you accepted the our"
              }}
              <a href="#" class="fst-normal text-dark">{{
                rtl ? "سياستنا." : "Policy."
              }}</a>
            </small>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <small class="small">
              ...
              <small class="fw-bold text-decoration-underline">Iteck Co.</small>
              {{
                rtl

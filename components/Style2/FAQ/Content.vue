<template>
  <div :class="`tab-pane ${isActive ? 'show active':''} fade`" :id="id" role="tabpanel">
    <div class="faq-body">
      <div class="container">
        <div class="row gx-5">
          <div class="col-lg-4">
            <div class="faq-category">
              ...
              <ul>
                <li>
                  <a href="#accordion1" class="active" @click="handleClick"> Installation </a>
                  <span> 06 </span>
                </li>
                <li>
                  <a href="#accordion2" @click="handleClick"> Getting Started </a>
                  <span> 04 </span>
                </li>
                <li>
                  <a href="#accordion3" @click="handleClick"> Page Builder </a>
                  <span> 03 </span>
                </li>
                <li>
                  <a href="#accordion4" @click="handleClick"> Header Builder </a>
                  <span> 03 </span>
                </li>
                <li>
                  <a href="#accordion5" @click="handleClick"> Footer Builder </a>
                  <span> 04 </span>
                </li>
                <li>
                  <a href="#accordion6" @click="handleClick"> Support </a>
                  <span> 05 </span>
                </li>
              </ul>
            </div>

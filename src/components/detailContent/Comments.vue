<template>
  <div class="blog-comments mt-70">
    ...
    <div class="comments-content mt-70">
      ...
      <div
        :class="`comment-replay-cont ${
          index !== comments.length - 1 ? 'border-bottom border-1 brd-gray' : ''
        } pb-40 pt-40`"
      ...
      >
        <div class="d-flex comment-cont">
          ...
          <div class="inf">
            ...
            <a
              href="#"
              :class="`butn border border-1 rounded-pill border-blue${styleType} mt-20 py-2 px-3 hover-blue${styleType} color-blue${styleType}`"
            >
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="form-group mb-30">
            <textarea
              class="form-control radius-4 fs-12px p-3"
              rows="6"
        ...
        <div class="col-lg-12">
          <div class="form-check mt-20">
            ...
            <label class="form-check-label fs-12px" for="flexCheckDefault">
              {{
                rtl
                  ? "احفظ اسمي والبريد الإلكتروني في هذا المتصفح لاستخدامها المرة المقبلة في تعليقي"
        ...
        <div class="col-12">
          <a
            href="#"
            :class="`btn rounded-pill blue${styleType}-3Dbutn hover-blue4 sm-butn fw-bold mt-40`"
          >

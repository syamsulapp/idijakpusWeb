<template>
  <header :class="`about-page-sec style-5 ${paddingTop ? 'pt-100' : ''}`">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-8">
          <div class="info">
            <h1>
              <template v-if="rtl">
                نحن نقدم حلول تكنولوجيا المعلومات المثالية لأي
              </template>
              <template v-else>
              ...
              <span class="ms-2">
                {{ rtl ? "شركة ناشئة" : "Cabang Jakarta Pusat" }}
                <img
            ...
            <!-- <p>
                {{
                  rtl
                    ? "يساعدك Iteck على توحيد هوية علامتك التجارية من خلال جمع وتخزين "
                    : "Iteck helps you unify your brand identity by collecting, storing and distributing"
                }}
                <br />
                {{
                  rtl
                    ? "وتوزيع رموز وأصول التصميم - تلقائيًا."
        ...
        <div class="col-lg-12">
          <div class="main-vid">
            <img src="/assets/img/galeri_idi.png" alt="" />
            <a
...
<script>
import ModalVideo from "../../source/Video.vue";
